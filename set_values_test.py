...
print_value(
    charger, "ebe"
)  # ebe is boost active/inactive - for simple check in apply if changes applied in general
...
print("======= SET VALUES =======")
if charger.allProps["ebe"] == True:
    send_value(charger, "ebe", False)
else:
    send_value(charger, "ebe", True)
